...
function NumPicker(props){
    ...
    return(
        <div className="numPicker">
            <h2>Select Number of Hours Before Now</h2>
            <p className="dissappear-medium">Number represents how many hours prior the baloon and weather data will be from the current time.</p>
